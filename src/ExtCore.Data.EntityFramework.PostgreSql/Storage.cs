...
namespace ExtCore.Data.EntityFramework.PostgreSql
{
  ...
  /// PostgreSQL database storage context and committing the changes made by all the repositories.
  /// </summary>
  public class Storage : IStorage
  {
    ...
    {
      TRepository repository = ExtensionManager.GetInstance<TRepository>(a => a.FullName.ToLower().Contains("entityframework.postgresql"), this.StorageContext);
